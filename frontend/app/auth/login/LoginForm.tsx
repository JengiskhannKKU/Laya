...
// แยกไฟล์นี้ออกจาก page.tsx (page.tsx เป็น server component เปล่าๆ) ตามแพทเทิร์นเดียวกับ
// VerifyEmailForm.tsx — ถ้า "use client" อยู่ที่ page.tsx โดยตรงจะเจอ hydration mismatch
// (server ส่ง fallback แต่ client resolve เนื้อหาจริงทันที เพราะ Next แยก static/dynamic
// ตาม segment ไม่ได้ถ้า client boundary เริ่มที่ page.tsx เอง)
