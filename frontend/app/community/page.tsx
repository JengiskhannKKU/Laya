...
const SHOP_COVERS: Record<string, string> = {
  "ตระการตา": "/images/Gallery/LINE_ALBUM_29669_260724_3.jpg",
  "Trakanta": "/images/Gallery/LINE_ALBUM_29669_260724_3.jpg",
};

/** การ์ดร้านค้าชุมชนทรงกะทัดรัด (Shopee Official Mall Style) */
function CommunityGridCard({ community }: { community: LiveCommunity }) {
  const { t } = useLanguage();
  const coverUrl = SHOP_COVERS[community.name] || community.image || "/images/Gallery/LINE_ALBUM_29669_260724_3.jpg";
                  ...
                  <Link key={c.id} href={`/community/${c.id}`} style={{ textDecoration: "none" }}>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <Image
                            src={SHOP_AVATARS[c.name] || c.image || "/images/trakanta.jpg"}
                            alt={c.name}
                            fill
                            style={{ objectFit: "cover" }}
                          />
